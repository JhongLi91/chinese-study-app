...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    >
      {children}
      <DialogPrimitive.Close className="absolute right-5 top-5 rounded-xl p-2 text-slate-400 opacity-70 transition-opacity hover:opacity-100 hover:bg-slate-800 hover:text-slate-100 focus:outline-none cursor-pointer">
        <X className="h-4 w-4" />
